...
--
-- Depends on: random-walk-schema.sql (edge_records, layer_buffer, seed_channels,
--             invalid_channels)
-- =============================================================================
...
CREATE TABLE pending_edge_batches (
    ...
    source_page_id VARCHAR(36)  NOT NULL,         -- parent_id for next layer_buffer insert
    ...
    -- 'completed'  = walkback done, edge_records + layer_buffer written
