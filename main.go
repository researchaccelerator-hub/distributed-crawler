...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&crawlerCfg.PrefixCase, "prefix-case", "lower", "Character case for YouTube random prefix generation: 'lower' (a-z0-9_-) or 'matchcase' (A-Za-z0-9_-)")
	...
	viper.BindPFlag("crawler.prefixcase", rootCmd.PersistentFlags().Lookup("prefix-case"))
