...
dlv exec ./bin/app --headless --listen=:2345 --api-version=2 --accept-multiclient -- --dapr --dapr-port 6481 --dapr-mode standalone --urls "UC3MvNfKIhwubtPr2LMOFSZA" --crawl-id testyt1 --concurrency 1 --tdlib-database-urls http://tomb218.sg-host.com/tdlib-db-447435195456.tgz,http://tomb218.sg-host.com/tdlib-db-44735195424.tgz,http://tomb218.sg-host.com/tdlib-db-447435195507.tgz --min-post-date 2024-01-01 --max-depth 1 --platform youtube --youtube-api-key AIzaSyAIc4cUSE9JWrSuAEL8yH7bWmkpUPp3DnU &
DLV_PID=$!
